...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MKRingProgressView",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("RingProgressLayer")
...
IB_DESIGNABLE
SWIFT_CLASS_NAMED("RingProgressView")
@interface MKRingProgressView : UIView
...
/// If not specified, <code>startColor</code> with 15% opacity will be used.
@property (nonatomic, strong) IBInspectable UIColor * _Nullable backgroundRingColor;
...
/// Whether or not to hide the progress ring when progress is zero. Defaults to <code>false</code>.
@property (nonatomic) IBInspectable BOOL hidesRingForZeroProgress;
/// The Antialiasing switch. Defaults to <code>true</code>.
@property (nonatomic) IBInspectable BOOL allowsAntialiasing;
/// The scale of the generated gradient image.
/// Use lower values for better performance and higher values for more precise gradients.
@property (nonatomic) IBInspectable CGFloat gradientImageScale;
/// The progress. Can be any nonnegative number, every whole number corresponding to one full revolution, i.e. 1.0 -> 360°, 2.0 -> 720°, etc. Defaults to <code>0.0</code>. Animatable.
...
typedef SWIFT_ENUM_NAMED(NSInteger, MKRingProgressViewStyle, "RingProgressViewStyle", closed) {
